...
namespace QLPKT
{
    public partial class edit_appointment : Form
    {
        ...
        private void editLichHen_Click(object sender, EventArgs e)
        {
            ...
            String query_editLH = "Update LICH_HEN Set LH_NGAYHEN = '"+ date_H.Value.ToString("yyyy-MM-dd") + "', LH_GIOHEN = '"+time_H.Value+"', LH_TRANGTHAI = N'"+status.Text+"' Where LH_ID = '"+ idLH + "'";
